...
var units = prompt("Write the number of units consumed");
var price = units * 10;
...
if (units > 100 && units <= 200) {
    console.log(price + tx10 + "<>" + "Is bill of electricity");
}
if (units > 200 && units <= 300) {
    console.log(price + tx15 + "<>" + "Is bill of electricity");
}
if (units > 300 && units <= 400) {
    console.log(price + tx20 + "<>" + "Is bill of electricity");
}
if (units > 400 && units <= 500) {
    console.log(price + tx25 + "<>" + "Is bill of electricity");
}
if (units > 500) {
    console.log(price + tx30 + "<>" + "Is bill ofelectricity");
}
